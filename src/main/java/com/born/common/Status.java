...
public class Status {
	...
	public static Status LOGIN_SUCCESS = new Status(500216, "登录成功");
	public static Status LOGOUT_SUCCESS = new Status(500217, "成功退出登录，用户信息已清空");
	public static Status USER_INFO_LOSS = new Status(500218, "获取用户信息失败，请重新登陆");

	//商品模块 5003XX
	public static Status GOODS_NOT_EXIST =new Status(500300,"商品不存在");
	public static Status GOODS_ABNORMAL_DELETE = new Status(500301,"商品被异常删除");

	//订单模块 5004XX
	public static Status ORDER_NOT_EXIST =new Status(500400,"订单不存在");
	public static Status ORDER_HAS_EXIST =new Status(500401,"订单已存在");
	public static Status ORDER_STATUS_UPDATE_FAIL=new Status(500402,"订单更新失败");
	public static Status ORDER_STATUS_UPDATE_SUCCESS=new Status(500403,"订单更新成功");
	...
	public static Status SECKILL_NOT_EXIST = new Status(500505, "秒杀商品不存在");
	public static Status SECKILL_WAITING = new Status(500506, "秒杀进行中");
	public static Status SECKILL_SUCCESS = new Status(500506, "秒杀进行中");
